...
// フォントサイズ
const HEADER_LABEL_SIZE: f32 = PIXELS_PER_CELL * 0.58;
const HEADER_VALUE_SIZE: f32 = PIXELS_PER_CELL * 0.7;
const FOOTER_LABEL_SIZE: f32 = PIXELS_PER_CELL * 0.48;
const FOOTER_VALUE_SIZE: f32 = PIXELS_PER_CELL * 0.4;
...
// 表示する数値を整形する関数
fn format_i32_02(x: &dyn std::fmt::Display) -> String { format!("{:02}", x) }
fn format_i32_05(x: &dyn std::fmt::Display) -> String { format!("{:05}", x) }
fn format_f32_06_2(x: &dyn std::fmt::Display) -> String { format!("{:06.2}", x) }

//------------------------------------------------------------------------------

const HEADER_STAGE: header_footer::TextBlock = header_footer::TextBlock {
...
const HEADER_SCORE: header_footer::TextBlock = header_footer::TextBlock {
...
const HEADER_HI_SCORE: header_footer::TextBlock = header_footer::TextBlock {
...
const FOOTER_FPS: header_footer::TextBlock = header_footer::TextBlock {
...
const FOOTER_AUTHER: header_footer::TextBlock = header_footer::TextBlock {
    ...
    #[rustfmt::skip]
    textspans: &[
        ( APP_COPYRIGHT, ASSETS_FONT_ORBITRON_BLACK, FOOTER_LABEL_SIZE, COLOR_TEAL ),
    ],
    update_info: None,
};

const FOOTER_POWERED_BY: header_footer::TextBlock = header_footer::TextBlock {
